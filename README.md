About descriptastorus-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/descriptastorus-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/descriptastorus-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add descriptastorus
# for installing globally
pixi global install descriptastorus
```
...
It is possible to list all of the versions of `descriptastorus` available on your platform:
...
```
pixi search descriptastorus --channel conda-forge
```
